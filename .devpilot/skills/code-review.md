...
Used by the **Team Lead** in the review phase, on demand via `/code-review`, and by developers
...
3. **Security** — run `security-scan.md` over the diff: input validation, authz,
...
7. **Performance & operability** — `performance.md` over queries/loops/rendering;

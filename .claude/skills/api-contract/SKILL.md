---
name: api-contract
description: "One committed OpenAPI spec binds the .NET API and the generated Angular client; snapshot and breaking-change checks."
when_to_use: "When an endpoint or DTO changes, or the Angular app calls an API."
paths:
  - "**/openapi*.json"
  - "**/openapi*.yaml"
  - "**/*api-client*/**"

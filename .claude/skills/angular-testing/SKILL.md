...
description: "Angular unit and component tests with Vitest + TestBed: HttpTestingController, harnesses, signal-service stubs."
when_to_use: "When writing or fixing Angular *.spec.ts files."
paths:
  - "**/*.spec.ts"

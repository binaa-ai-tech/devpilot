...
description: "Layer rules for Angular + ASP.NET Core: Controller/Endpoint -> Service -> Repository, smart/dumb components, no cross-layer leaks."
when_to_use: "When planning, implementing or reviewing code that crosses layers."

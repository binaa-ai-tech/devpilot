...
description: "Derive test cases from acceptance criteria (boundaries, negatives, traceability) before writing test code."
when_to_use: "In the QA phase or /dp-test, before any test code."
...
to retrofit in code. `test-strategy` says *what layers* to test; this says
